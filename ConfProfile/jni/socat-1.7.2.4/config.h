...
//OCPA change: #define HAVE_RESOLV_H 1
...
//OCPA change: #define WITH_SOCKS4 1
//OCPA change: #define WITH_SOCKS4A 1
//OCPA change: #define WITH_PROXY 1
#define WITH_EXEC 1
#define WITH_SYSTEM 1
/* #undef WITH_READLINE */
#define WITH_TUN 1
#define WITH_PTY 1
//OCPA change: #define WITH_EXT2 1
/* #undef WITH_OPENSSL */
...
#define WITH_SYCLS 1
//OCPA change: #define WITH_FILAN 1
#define WITH_RETRY 1
