...
strongswan_USE_BYOD := 
#TODO: fix libandroidbridge compilation errors while USE_BYOD = true

strongswan_CHARON_PLUGINS := android-log openssl fips-prf random nonce pubkey \
	pkcs1 pkcs8 pem xcbc hmac socket-default kernel-netlink \
	eap-identity eap-mschapv2 eap-md5 eap-gtc xauth-generic unity
...
include jni/strongswan/Android.common.mk
